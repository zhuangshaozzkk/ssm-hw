...
<head>
    ...
    <%--   web路径：不以/开始的相对路径，找资源是以当前资源的路径为基准，经常容易出问题而以/开始的相对路径，是以服务器的路径为标注的（http://localhost:3306），需要加上项目名http://localhost:3306/ssm-hw--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="empName" class="form-control" id="empName_add_input"
                                   placeholder="empName" autocomplete="off">
...
<script type="text/javascript">
    ...
    // 绑定单击.live()，而新版jQuery没有live方法，而是用on进行替代
    ...
    $("#emp_update_btn").click(function () {
        //验证邮箱是否合法
        if (validate_update_email() == false) {
            return false;
        }
